...
#
# Generated by Vivado on Fri Mar 13 16:01:51 CET 2026
...
proc print_help {} {
  ...
  puts "$script_file -tclargs \[--build_bitstream\]\n"
  puts "Usage:"
  ...
  puts "\[--build_bitstream\]   Launch synth/impl and generate bitstream"
  puts "-------------------------------------------------------------------------\n"
  exit 0
}
...
if { $::argc > 0 } {
  for {set i 0} {$i < $::argc} {incr i} {
    ...
    switch -regexp -- $option {
      ...
      "--build_bitstream" { set build_bitstream 1 }
      "--help"         { print_help }
      default {
        if { [regexp {^-} $option] } {
...
\
  ...
  connect_bd_intf_net -intf_net Conv2D_HW_0_m_axi_gmem [get_bd_intf_pins Conv2D_HW_0/m_axi_gmem] [get_bd_intf_pins axi_mem_intercon/S00_AXI]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.870717",
   "Default View_TopLeft":"0,-269",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1210 -y -20 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1210 -y 0 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 240 -y 30 -defaultsOSRD
preplace inst Conv2D_HW_0 -pg 1 -lvl 1 -x 240 -y -140 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -x 1030 -y 160 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 2 -x 670 -y 200 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 3 -x 1030 -y -200 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 10 140 470 70 860
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 460 80n
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 0 3 20 -220 470J -140 870
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 NJ 40 850
preplace netloc ps7_0_axi_periph_M00_AXI 1 0 4 10 -320 NJ -320 NJ -320 1180
...
preplace netloc Conv2D_HW_0_m_axi_gmem 1 1 2 NJ -150 850
preplace netloc axi_mem_intercon_M00_AXI 1 0 4 0 -330 NJ -330 NJ -330 1190
levelinfo -pg 1 -20 240 670 1030 1210
pagesize -pg 1 -db -bbox -sgen -20 -340 1330 300
"
}
...
# Force project language for wrapper
set_property target_language VHDL [current_project]

# Regenerate BD products from scratch
reset_target all [get_files -norecurse design_1.bd]
generate_target all [get_files -norecurse design_1.bd]

# Remove stale wrapper from sources_1 (avoid conflicts)
set stale_wrappers [get_files -quiet -of_objects [get_filesets sources_1] *design_1_wrapper.vhd]
if { [llength $stale_wrappers] > 0 } {
  remove_files $stale_wrappers
}

# Recreate wrapper (VHDL) and add it
set wrapper_path [make_wrapper -files [get_files -norecurse design_1.bd] -top -force]
add_files -norecurse -fileset sources_1 $wrapper_path

# Sync generated files and compile order
export_ip_user_files -of_objects [get_files -norecurse design_1.bd] -no_script -sync -force -quiet
