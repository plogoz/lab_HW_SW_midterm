...
set name Conv2D_HW_mul_32s_32s_52_2_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 1 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_inputWidth \
    op interface \
    ports { inputWidth { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_inputHeight \
    op interface \
    ports { inputHeight { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln20 \
    op interface \
    ports { mul_ln20 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln20 \
    op interface \
    ports { select_ln20 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_convWidth \
    op interface \
    ports { convWidth { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln3_1 \
    op interface \
    ports { mul_ln3_1 { I 96 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_p_cast8_mid145 \
    op interface \
    ports { p_cast8_mid145 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 24 \
    name tmp4_cast_mid167 \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_tmp4_cast_mid167 \
    op interface \
    ports { tmp4_cast_mid167 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_icmp_ln27_1 \
    op interface \
    ports { icmp_ln27_1 { I 1 vector } } \
} "
}
...
set InstName Conv2D_HW_flow_control_loop_pipe_sequential_init_U
set CompName Conv2D_HW_flow_control_loop_pipe_sequential_init
