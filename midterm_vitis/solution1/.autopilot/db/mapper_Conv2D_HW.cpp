...
using hls::sim::Byte;
extern "C" void Conv2D_HW(Byte<4>*, int, int, int, int, int, int, int, int, int);
extern "C" void apatb_Conv2D_HW_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r, volatile void * __xlx_apatb_param_coeffs, int __xlx_apatb_param_numChannels, int __xlx_apatb_param_numFilters, int __xlx_apatb_param_inputWidth, int __xlx_apatb_param_inputHeight, int __xlx_apatb_param_convWidth, int __xlx_apatb_param_convHeight) {
...
__xlx_input_r_output_r_coeffs__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  int __xlx_offset_byte_param_output_r = 1*4;
for (size_t i = 0; i < 1; ++i){
__xlx_input_r_output_r_coeffs__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_coeffs)[i]);
}
  int __xlx_size_param_coeffs = 1;
  int __xlx_offset_param_coeffs = 2;
  int __xlx_offset_byte_param_coeffs = 2*4;
  // DUT call
