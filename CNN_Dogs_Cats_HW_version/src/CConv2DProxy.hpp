...
class CConv2DProxy : public CAccelProxy {
  protected:
    ...
    struct TRegs {
      ...
      uint32_t padding4;    // 0x2C
      uint32_t padding5;    // 0x30

      uint32_t numChannels; // 0x34
      uint32_t padding6;    // 0x38

      uint32_t numFilters;  // 0x3C
      uint32_t padding7;    // 0x40

      uint32_t inputWidth;  // 0x44
      uint32_t padding8;    // 0x48

      uint32_t inputHeight; // 0x4C
      uint32_t padding9;    // 0x50

      uint32_t convWidth;   // 0x54
      uint32_t padding10;   // 0x58
